...
import com.example.rabbitmqexample.producer.RabbitJsonProducer;
...
public class RabbitController {
	...
	@Autowired
	RabbitJsonProducer jsonProducerService;
	...
	public String sendMessageJson(@RequestBody Student student) {
		...
		this.jsonProducerService.JsonMessageProduce(student);
